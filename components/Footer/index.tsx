...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp dark:bg-gray-dark relative z-10 bg-bg-light pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Template by MCommerce and{" "}
              <Link href="https://www.linkedin.com/in/adnanahmad9334/" rel="nofollow noopener">
                Managed By Adnan
              </Link>
            </p>
          </div>
