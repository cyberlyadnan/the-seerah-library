      ...
      <div className="container">
        <div className="mx-auto w-full md:w-[80%]">
          <SectionTitle
            ...
            paragraph="Learn. Reflect. Transform. Our curated collection of books on the Seerah of Prophet Muhammad ﷺ offers a profound journey into his life and teachings. Explore, engage, and enrich your understanding."
            center
          />
        </div>
