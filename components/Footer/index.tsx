...
const Footer = () => {
  ...
  return (
    <footer className="wow fadeInUp dark:bg-gray-dark relative z-10 bg-bg-light pt-16 md:pt-20 lg:pt-24">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              <Link href="/" className="mb-8 inline-block">
                <Image
                  src={footerData.company.logo.light}
                ...
                />
                <Image
                  src={footerData.company.logo.dark}
                  alt={footerData.company.logo.alt}
