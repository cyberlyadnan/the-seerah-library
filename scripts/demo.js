...
const books =  [
{
  ...
  totalRatings: 0,
  language: 'English',
  description: 'A spiritual journey through the character and message of the Prophet ﷺ, emphasizing his compassion and wisdom.'
},
{
  ...
  totalRatings: 0,
  rating: 0,
  description: 'A 4-volume Seerah from one of the most respected scholars in Islamic history, based on authentic narrations.',
  totalReviews: 0,
...
},
{
  ...
  totalRatings: 0,
  description: 'The earliest and most authentic biography of the Prophet ﷺ, compiled by the classical historian Ibn Ishaq.',
  language: 'English'
},
{
  ...
  rating: 0,
  isFeatured: false,
  description: 'A simplified and illustrated version of the Seerah suitable for readers of all ages.',
...
},
{
  ...
  rating: 0,
  description: 'A beautifully written Seerah drawing from early sources with deep insight and literary flair.',
...
},
{
  ...
  language: 'English',
  genre: [ 'Biography', 'Seerah' ],
  description: 'An award-winning biography of the Prophet ﷺ, offering a detailed and authentic account of his life.',
  publishDate: '1976',
